...
class TranslateBaiduSpider(scrapy.Spider):
    ...
    start_urls = ['http://fanyi.baidu.com/translate/']
    ...
    def parse_item(self, response):
        ...
        if edict:
            ...
            sentences = [item for tr_group in tr_groups for example in tr_group.get("tr_group") for item in
                         example.get("example")]
            example_sentences.extend(sentences)
        ...
        if collins:
            ...
            for item_info in entry:
                ...
                for value_info in value:
                    ...
                    collins_w = dr.sub('', word_def).strip()
                    example_sentences.append(collins_w)
                    ...
                    for example_info in mean_type:
                        ...
                        if example:
                            ...
                            example_sentences.append(collins_s)
        # 牛津
        ...
        if oxford:
            ...
            example_sentences.extend(oxford_sentences)
        ...
        if synonym:
            ...
            for syn in synonyms:
                example_sentences.extend([item.get("enText") for item in syn.get("ex")])
        ...
        if usecase:
            ...
            example_sentences.extend([case.get("enText") for case in usecase_sentence_dict])
